...
public abstract class CustomCountDownTimer {
    ...
    private synchronized CustomCountDownTimer start(long millisInFuture) {
        ...
        mStopTimeInFuture = SystemClock.elapsedRealtime() + millisInFuture; // 1000 + 10000
    ...
    public synchronized final void pause() {
        ...
        isPause = true;
        mPauseTimeInFuture = mStopTimeInFuture - SystemClock.elapsedRealtime(); // 1000
        mHandler.removeMessages(MSG);
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (CustomCountDownTimer.this) {
                ...
                final long millisLeft = mStopTimeInFuture - SystemClock.elapsedRealtime(); // 1002 11000 9998
                Log.i("CustomCountDownTimer", "millisLeft: " + millisLeft);
                if (millisLeft <= 0) {
                    onFinish();
                } else {
                    long lastTickStart = SystemClock.elapsedRealtime(); // 1003
                    onTick(millisLeft);

                    // take into account user's onTick taking time to execute
                    long delay = lastTickStart + mCountdownInterval - SystemClock.elapsedRealtime(); // 2003 - 1004
