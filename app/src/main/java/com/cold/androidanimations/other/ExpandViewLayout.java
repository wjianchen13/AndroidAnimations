 ...
 * @describe
 */
public class ExpandViewLayout extends TextSwitcher implements ViewFactory{
    private int index= -1;
    ...
    public ExpandViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
    private void init() {
        ...
        this.setInAnimation(AnimationUtils.loadAnimation(context, R.anim.switch_in_animation));
        this.setOutAnimation(AnimationUtils.loadAnimation(context, R.anim.switch_out_animation));
    }
